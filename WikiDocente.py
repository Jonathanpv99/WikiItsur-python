...
busc_button = Button(window, text="Buscar materias", font=("Arial", 11), bg="#052E1A", fg="#ffffff")
...
tema_entry = Entry(window, font=("Arial", 12), show="*")
...
login_button = Button(window, text="Registrar", font=("Arial", 12), bg="#052E1A", fg="#ffffff", command=login)
...
welcome_label.place(x=50, y=500)
